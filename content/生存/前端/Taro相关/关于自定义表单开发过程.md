...
5. 现在升级完后有一个代码规范的报错，暂时还解决不了。看他们的issue上面也有很多人遇到这个问题，按照上面别人的办法尝试后也不能解决我本地的问题。[react ts提示异常 · Issue #11097 · NervJS/taro · GitHub](https://github.com/NervJS/taro/issues/11097)
