...
I worked normally today, managed to focus a bit more. In the evening, I received a storage box ordered from Taobao, and later waited for a delivery from Shunfeng (SF Express). After it arrived, I went for a run and then exercised my back. Ordered a steak for dinner
